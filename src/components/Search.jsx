...
const Search = () => {
  ...
  const {input, randomMeal, setInput}=useGlobalContext()
  ...
  return (
    <div className="grid grid-cols-2 justify-items-center content-center z-10 fixed bg-[#e8ead9] w-full top-0 left-0 right-0 opacity-70 hover:opacity-100">
      <div className="underline underline-offset-4 font-mono flex items-center justify-center text-3xl md:text-6xl my-5 w-full ">Recipe Master</div>
